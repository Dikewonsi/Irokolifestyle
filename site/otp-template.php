...
<head>
    ...
    <title>IrokoLifestyle | Email Verification </title>
                        ...
                        <tr class="header">
                            <td align="left" class="header-logo"
                                ...
                                <a href="https://irokolifestyle.com">
                                    <img src="https://irokolifestyle.com/assets/images/iroko.png" class="main-logo" alt="logo">
                                </a>
                            </td>
                            <td class="header-contain" style="display: block;">
                                <ul>
                                    <li style="display: block;text-decoration: unset;">
                                        <img src="https://irokolifestyle.com/assets/images/email/otp.png" alt="no-img">
                                    </li>

                                    <li style="display: block;text-decoration: unset" class="reset-contain">
                                        <h2>Verify your Email Address</h2>
                                        <h4 class="market">Here's your OTP below, Copy and Paste to complete your registration</h4>
                            ...
                            <tr>
                                <div class="title title-2 text-center">
                                    <h6>your email :-<a href="#"
                                            style="font-weight: 600; text-decoration: underline;">{TO_EMAIL}</a>
                                    </h6>
