...
<head>
    ...
    <title>eCryptomarket | Forgot Password </title>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr class="header">
                            <td align="left" class="header-logo"
                                ...
                                <a href="https://irokolifestyle.com">
                                    <img src="https://irokolifestyle.com/assets/images/email/iroko.png" class="main-logo" alt="logo">
                                </a>
                            </td>
                            <td class="header-contain" style="display: block;">
                                <ul>
                                    <li style="display: block;text-decoration: unset;">
                                        <img src="https://irokolifestyle.com/assets/images/email/reset.png" alt="reset-img">
                                    </li>

                                    <li style="display: block;text-decoration: unset" class="reset-contain">
                                        <h2>reset your password</h2>
                                        <h4 class="market">That's okay,it happens! Copy the OTP below and paste it on the OTP Verification page</h4>
                                        <strong>{OTP}</strong>
                                    </li>
                                </ul>
                            </td>
                            ...
                            <tr>
                                <div class="title title-2 text-center">
                                    <h6>your email :- <a href="#"
                                            style="font-weight: 600; color:#977767; text-decoration: underline;">{TO_EMAIL}</a>
                                    </h6>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript:void(0)">
                                                <img src="https://irokolifestyle.com/assets/images/email/fb.png" alt=""
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0)">
                                                <img src="https://irokolifestyle.com/assets/images/email//twitter.png" alt=""
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0)">
                                                <img src="https://irokolifestyle.com/assets/images/email//insta.png" alt=""
                                                    style="font-size: 25px; margin: 0 18px 0 0;width: 22px;filter: invert(1);">
                                            </a>
                                        </td>
                                        <td>
                                            <a href="javascript:void(0)">
                                                <img src="https://irokolifestyle.com/assets/images/email//google-plus.png" alt=""
                                    ...
                                    <tr>
                                        <td>
                                            <h5
                                                ...
                                                This email was generated automatically. Do not reply to this message.</h5>
                                            <h5
