    ...
    <?php include('header.php'); ?>
            ...
            <div class="page-body">
                <div class="title-header">
                    <h5>Tracking Wallet Transaction</h5>
                    <p>Track any transaction by searching with the tracking number</p>
                </div>                
                                            ...
                                            <form class="theme-form theme-form-2 mega-form" method="POST" action="code.php">
                                                <div class="row">
                                                    ...
                                                    <div class="card-footer text-end border-0 pt-0">
                                                        <button type="submit" name="trackWalletBtn" class="btn btn-primary me-3">Submit</button>
