...
<head>
    ...
    <title>IrokoLifestyle - Edit Order Status</title> 
                                            ...
                                            <div class="col-xl-8">
                                                <form class="theme-form theme-form-2 mega-form" method="POST" action="code.php">
                                                    <div class="mb-4 row align-items-center">
                                                        <label
                                                            class="col-sm-2 col-form-label form-label-title">Shipment Status</label>
                                                        <div class="col-sm-10">
                                                            <select class="js-example-basic-single w-100" name="status">
                                                                <option value=<?= $data['ship_status']; ?>><?= $data['ship_status']; ?></option>
                                                    ...
                                                    <div class="card-footer text-end border-0 pt-0">
                                                        <a href="view-order.php" class="btn btn-outline-primary">Cancel</a>
                                                        <button type="submit" name="editShipBtn" class="btn btn-primary me-3">Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
