                ...
                <div class="col-12 p-0">
                    <div class="success-icon">
                        ...
                        <div class="success-contain">
                            <h4 style="color:#977767;">Top-Up Success</h4>
                            <h5 class="font-light">Payment is successfully processed and your wallet has been credited.</h5>                            
                            <h6 class="font-light">Click <a href="user-dashboard.php">Here</a> to view your balance from your user dashboard.</h6>
                        </div>
                    </div>
                </div>
            </div>
